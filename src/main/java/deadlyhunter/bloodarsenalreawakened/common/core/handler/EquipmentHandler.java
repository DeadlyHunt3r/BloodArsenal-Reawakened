package deadlyhunter.bloodarsenalreawakened.common.core.handler;
...
public abstract class EquipmentHandler
{
    ...
    {
//        if (BloodArsenalReawakened.curiosLoaded)
//        {
...
//            player.world.getProfiler().startSection("bloodarsenalreawakened:tick_wearables");
//
