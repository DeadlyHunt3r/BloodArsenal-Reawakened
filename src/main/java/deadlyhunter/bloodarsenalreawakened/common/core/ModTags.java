...
public final class ModTags
{
    ...
    public static class Items
    {
        ...
        {
            return ItemTags.makeWrapperTag(BloodArsenalReawakened.rl(name).toString());
        }
    ...
    public static class Blocks
    {
        ...
        {
            return BlockTags.makeWrapperTag(BloodArsenalReawakened.rl(name).toString());
        }
    ...
    public static class Entities
    {
        ...
        {
            return EntityTypeTags.getTagById(BloodArsenalReawakened.rl(name).toString());
        }
    }
}
