...
{
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, BloodArsenalReawakened.MOD_ID);
    ...
    public static final RegistryObject<Block> BLOOD_INFUSED_PLANKS = registerBlock("blood_infused_planks", new BloodArsenalReawakenedBlock(PROP_BLOOD_INFUSED_WOOD));
    ...
    public static final RegistryObject<Block> BLOOD_INFUSED_IRON_BLOCK = registerBlock("blood_infused_iron_block", new BloodArsenalReawakenedBlock(PROP_BLOOD_INFUSED_IRON));
    public static final RegistryObject<Block> BLOOD_INFUSED_GLOWSTONE = registerBlock("blood_infused_glowstone", new BloodArsenalReawakenedBlock(Properties.create(Material.GLASS, MaterialColor.RED).hardnessAndResistance(0.75F, 1).sound(SoundType.GLASS).setLightLevel(s -> 15)));
    public static final RegistryObject<Block> FRACTURED_GLASS = registerBlock("fractured_glass", new BloodArsenalReawakenedGlassBlock(Properties.from(Blocks.GLASS)));
    public static final RegistryObject<Block> BLOOD_STAINED_GLASS = registerBlock("blood_stained_glass", new BloodArsenalReawakenedGlassBlock(PROP_BLOOD_STAINED_GLASS));
    public static final RegistryObject<Block> SPARKLING_BLOOD_STAINED_GLASS = registerBlock("sparkling_blood_stained_glass", new BloodArsenalReawakenedGlassBlock(PROP_BLOOD_STAINED_GLASS.setLightLevel(s -> 15)));
    public static final RegistryObject<Block> BLOOD_STAINED_GLASS_PANE = registerBlock("blood_stained_glass_pane", new BloodArsenalReawakenedGlassPaneBlock(PROP_BLOOD_STAINED_GLASS));
    ...
    public static final RegistryObject<Block> BLANK_SLATE = registerBlock("blank_slate", new BloodArsenalReawakenedBlock(PROP_SLATE));
    public static final RegistryObject<Block> REINFORCED_SLATE = registerBlock("reinforced_slate", new BloodArsenalReawakenedBlock(PROP_SLATE));
    public static final RegistryObject<Block> IMBUED_SLATE = registerBlock("imbued_slate", new BloodArsenalReawakenedBlock(PROP_SLATE));
    public static final RegistryObject<Block> DEMONIC_SLATE = registerBlock("demonic_slate", new BloodArsenalReawakenedBlock(PROP_SLATE));
    public static final RegistryObject<Block> ETHEREAL_SLATE = registerBlock("ethereal_slate", new BloodArsenalReawakenedBlock(PROP_SLATE));
	public static final RegistryObject<Block> GLASS_SHARDS = BLOCKS.register("glass_shards", GlassShardsBlock::new);
