...
import deadlyhunter.bloodarsenalreawakened.common.core.Constants;
import deadlyhunter.bloodarsenalreawakened.common.util.Utils;
import deadlyhunter.bloodarsenalreawakened.common.util.helper.NBTHelper;
...
public class LightningSigilItem extends SigilBaseItem
{
    ...
    public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity player, Hand hand)
    {
        ...
        if (!world.isRemote)
        {
            ...
            if (player.isSneaking())
            {
                ...
                player.sendStatusMessage(new TranslationTextComponent(TextHelper.localizeEffect("chat.bloodarsenalreawakened.set_level", TextHelper.toRoman(NBTHelper.getInt(stack, Constants.NBT.LEVEL, 0) + 1))), true);
            ...
            else if (!isUnusable(stack))
            {
                ...
                if (rayTrace != null)
                {
                    ...
                    {
                        player.sendStatusMessage(new TranslationTextComponent(TextHelper.localize("chat.bloodarsenalreawakened.too_weak")), true);
                        return ActionResult.resultFail(stack);
                    }
                }
            }
    ...
    public void addInformation(ItemStack stack, World world, List<ITextComponent> tooltip, ITooltipFlag flag)
    {
        ...
        tooltip.add(new TranslationTextComponent(TextHelper.localize("tooltip.bloodarsenalreawakened.level", TextHelper.toRoman(NBTHelper.getInt(stack, Constants.NBT.LEVEL, 0) + 1))).mergeStyle(TextFormatting.GRAY));
    }
}
