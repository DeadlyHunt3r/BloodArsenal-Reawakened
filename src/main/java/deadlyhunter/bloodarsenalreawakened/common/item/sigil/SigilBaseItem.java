...
public class SigilBaseItem extends ItemSigil
{
    ...
    {
        tooltip.add(new TranslationTextComponent("tooltip.bloodarsenalreawakened." + getRegistryName().getPath() + ".desc").mergeStyle(TextFormatting.ITALIC).mergeStyle(TextFormatting.GRAY));
