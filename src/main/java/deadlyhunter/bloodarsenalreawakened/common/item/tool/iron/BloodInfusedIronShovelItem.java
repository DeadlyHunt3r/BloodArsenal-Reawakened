...
public class BloodInfusedIronShovelItem extends ShovelItem
{
    public BloodInfusedIronShovelItem(Properties properties)
    {
        this(ModItems.ItemTier.BLOOD_INFUSED_IRON, properties);
    }

    public BloodInfusedIronShovelItem(IItemTier material, Properties properties)
    {
