...
public final class ConfigHandler
{
    ...
    public static class Common
    {
		...
		public final ForgeConfigSpec.IntValue flightSigilCost;
        ...
        public Common(ForgeConfigSpec.Builder builder)
        {
			...
			flightSigilCost = builder
					.comment("LP cost per tick for the Flight Sigil. Default: 1000")
					.defineInRange("flightSigilCost", 1000, 0, Integer.MAX_VALUE);
            builder.pop();
